...
@Service
public class FindOtherLocalServiceImpl implements FindOtherLocalService {
    @Override
    public void getOtherLocal(String path) throws Exception {
        File file = new File(path);
        readImageInfo(file);
    }

    private void readImageInfo(File file) throws ImageProcessingException, Exception {
     ...
     */
    private void convertGpsToLoaction(double gps_latitude, double gps_longitude) throws IOException {
        String apiKey = "7QZq3RfbfuGoPU00m3uvPZr6jeNoeEnI";
        ...
        res = HttpClientUtils.doGet(url,null);
